...
const styles = StyleSheet.create({
  ...
  birthAvatarText: { color: theme.colors.onPrimary, fontWeight: '700' as any, fontSize: 14 },
  ...
  attAvatarText: { color: theme.colors.onPrimary, fontWeight: '700' as any, fontSize: 12 },
  ...
  attHealthText: { color: theme.colors.onPrimary, fontSize: 10, fontWeight: '700' as any },
